...
# Render par Environment Variables (Env Vars) use karna best hota hai, 
# par aap yahan direct bhi daal sakte hain.
TOKEN = os.environ.get("BOT_TOKEN")
API_ID = int(os.environ.get("API_ID", 37736800))  # Apna API_ID dalein
API_HASH = os.environ.get("API_HASH", "c0f93a1d887e5fcf03cebbeb65bcd1d2")  # Apna API_HASH dalein
    ...
    try:
        ...
        for gid in list(group_ids):
            try:
                ...
                bot.send_message(
                    gid,
                    "🌟 Keep your community safe with @dealwithcautions\n\n"
...
def imp_report_start(msg):
    ...
    markup = ReplyKeyboardMarkup(resize_keyboard=True)
    markup.row(KeyboardButton("Cancel Report"))
    bot.send_message(cid, "Send fake username.", reply_markup=markup)
